...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname parameterization-v2-a) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; parameterization-v2-a.rkt
...
;; given pred and (list n0 n1 ...) produce
;; the same list, but containing only numbers that
;; evaluates to true when passed to pred.
...
(check-expect (filter2 zero? (list 1 -2 3 -4)) empty)
