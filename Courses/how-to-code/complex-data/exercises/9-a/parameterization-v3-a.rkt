...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname parameterization-v3-a) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; parameterization-v3-a.rkt
...
(check-expect (map2 string-length (list "" "A" "Abc")) (list 0 1 3))
