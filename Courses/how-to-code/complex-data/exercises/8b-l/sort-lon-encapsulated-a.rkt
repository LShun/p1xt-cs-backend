...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname sort-lon-encapsulated-a) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
