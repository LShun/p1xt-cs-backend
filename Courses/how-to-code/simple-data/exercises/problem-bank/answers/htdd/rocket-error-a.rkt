...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname rocket-error-a) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
